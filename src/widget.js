...
export const WIDGET_SCRIPT = `(function () {
  ...
  var css = [
    ".csl-chat-btn{position:fixed;bottom:20px;right:20px;width:56px;height:56px;border-radius:50%;",
    "background:#2f3b2f;color:#fff;border:none;box-shadow:0 4px 12px rgba(0,0,0,.25);cursor:pointer;",
    "z-index:999999;font-size:24px;display:flex;align-items:center;justify-content:center;}",
    ".csl-chat-btn:hover{background:#3d4d3d;}",
    ".csl-chat-panel{position:fixed;bottom:88px;right:20px;width:340px;max-width:calc(100vw - 32px);",
    ...
    ".csl-chat-header{background:#2f3b2f;color:#fff;padding:14px 16px;font-weight:600;font-size:15px;",
    "display:flex;justify-content:space-between;align-items:center;}",
    ".csl-chat-close{background:none;border:none;color:#fff;font-size:18px;cursor:pointer;padding:0 4px;}",
    ".csl-chat-messages{flex:1;overflow-y:auto;padding:12px;background:#f7f7f5;}",
    ...
    ".csl-chat-msg.user{background:#2f3b2f;color:#fff;margin-left:auto;border-bottom-right-radius:4px;}",
    ".csl-chat-msg.bot{background:#e9e9e5;color:#222;margin-right:auto;border-bottom-left-radius:4px;}",
    ".csl-chat-msg.error{background:#fdecea;color:#611a15;margin-right:auto;}",
    ".csl-chat-msg.typing{background:#e9e9e5;color:#888;margin-right:auto;}",
    ...
    ".csl-chat-input:focus{border-color:#2f3b2f;}",
    ".csl-chat-send{background:#2f3b2f;color:#fff;border:none;border-radius:50%;width:36px;height:36px;",
  ...
  panel.innerHTML =
    ...
    "Hi! Ask me about floor plans, amenities, pet policy, leasing, or how to schedule a tour." +
    "</div></div>" +
